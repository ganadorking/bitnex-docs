...
- If your margin falls below the Protocol's maintenance requirements, your position is **liquidated automatically**. Liquidation is executed by the Protocol, not by Bitnex, and cannot be reversed.
...
- Trading fees (the Protocol's and Bitnex's builder fee) reduce your returns and are shown before you confirm each order.
...
- A trader's past performance — including every statistic shown on Bitnex — guarantees nothing about future results.
...
Guardian Mode blocks new orders **signed through the Bitnex interface** when your self-imposed limits are exceeded. It is a discipline tool, not a protective guarantee:
...
- **Smart contract / protocol risk:** the Protocol's on-chain system could contain bugs or be attacked. Funds live there, not on Bitnex.
...
- **Interface risk:** Bitnex itself can suffer outages, bugs, or display errors. Data shown (prices, PnL, statistics) can be delayed or wrong; the Protocol's on-chain state is authoritative.
...
Nothing on Bitnex — statistics, leaderboards, trader profiles, documentation, support answers — is investment advice or a recommendation. Bitnex owes you no fiduciary duty. Every trading decision, including the decision to copy another trader, is exclusively yours.

---

If any part of this statement is unclear, do not trade until you understand it. You can reach us through the in-app support chat at [bitnex.pro](https://bitnex.pro).

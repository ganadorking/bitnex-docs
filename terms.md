...
- You are acting for your own account and not on behalf of any other person or entity, unless you are duly authorized to bind them to these Terms.
...
To trade without a wallet pop-up on every order, you may approve an **agent wallet** on the Protocol. You acknowledge that:

- The agent wallet can **place and manage orders** on your account but **cannot withdraw or transfer funds** — a restriction enforced by the Protocol itself.
- Agent keys used for manual trading are generated and stored **in your browser**; the agent key used for copy trading is stored encrypted on our servers and used only by the copy engine (see the [Copy Trading Terms](legal/copy-trading-terms.md)).
- You can **revoke** any agent wallet at any time from the Interface, and approvals expire on-chain.
- You are responsible for the security of the devices and browsers where your keys live.

## 6. No Financial Advice

Nothing on the Interface constitutes investment, financial, legal, tax, or other professional advice. We do not recommend any asset, trade, strategy, or trader. Statistics, leaderboards, and trader profiles are informational Content computed from public data. You are solely responsible for your own decisions, and you should seek independent professional advice where appropriate.

## 7. Risks

Trading crypto assets, and especially **leveraged** trading, involves substantial risk. By using the Interface, you acknowledge and accept the risks described in the [Risk Disclosure Statement](legal/risk-disclosure.md), including that:
...
The Interface offers automation — copy trading, grid bots, TWAP and scale orders, take-profit/stop-loss, and Guardian Mode. All automation runs on a **best-effort basis**: it can be delayed, interrupted, or fail, and triggers do not guarantee execution prices. Copy trading is additionally governed by the [Copy Trading Terms](legal/copy-trading-terms.md) and Guardian Mode by the [Guardian Mode Terms](legal/guardian-terms.md), each accepted by wallet signature before first use.
...
## 12. Vaults, Staking and Other Features
...
The Interface depends on third parties we do not control — the Protocol, wallet providers, authentication providers, bridges, data feeds, and hosting infrastructure. We are not responsible for their acts, omissions, downtime, or data. Links to third-party sites or services are provided for convenience and are not endorsements. Content displayed on the Interface (prices, PnL, statistics) is informational; **the Protocol's on-chain state is authoritative** and may differ from what is displayed.
...
We may suspend, restrict, or terminate access to the Interface (in whole or in part, for all users or for a specific wallet) at any time, with or without notice, including for maintenance, security incidents, suspected violations of these Terms, or legal requirements. Because the Interface is non-custodial, suspension of the Interface **does not affect your funds**, which remain accessible on the Protocol through other clients. Sections that by their nature should survive termination (including limitations of liability, indemnification, and governing law) survive.

## 17. No Warranties

The Interface is provided **"as is" and "as available"**, without warranties of any kind, whether express or implied, including merchantability, fitness for a particular purpose, and non-infringement. We do not warrant that the Interface will be uninterrupted, error-free, secure, or that any information displayed is accurate, complete, or current. Your use of the Interface is at your own risk.
...
We are not liable for any failure or delay caused by events beyond our reasonable control, including blockchain network failures or congestion, attacks on the Protocol or its infrastructure, actions of third-party providers, labor disputes, war, terrorism, natural disasters, pandemics, or acts of government.
...
Any dispute arising out of or relating to these Terms or your use of the Interface shall be resolved on an **individual basis**; you waive any right to participate in a class action to the extent permitted by law. Before pursuing any formal action, you agree to first contact us and attempt to resolve the matter informally within sixty (60) days.
...
- **Language.** Translations may be provided for convenience; where they conflict, the English version prevails.
